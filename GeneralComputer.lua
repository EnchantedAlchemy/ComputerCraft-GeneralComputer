...
functions = {
	...
	ping = function(commands)
		...
		chatFunctions.privateMessage({text = "test", color = "white", bold = true}, commands[1])
		chatFunctions.privateMessage({text = "Distance: " .. distance .. " Blocks", color = "white", bold = true}, commands[1])
